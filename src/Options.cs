...
namespace EchoRooms
{
    public class Options : OptionInterface
    {
        ...
        public Options()
        {
            RandomModeConfig = config.Bind("ERR_RandomMode", RandomMode.EveryCycle, new ConfigurableInfo("Changes how often the locations randomize."));
        }
        ...
        public override void Initialize()
        {
            base.Initialize();
            Tabs = [new OpTab(this)];
            var title = new OpLabel(new Vector2(0f, 350f), new Vector2(600f, 30f), "ECHO ROOM RANDOMIZER", FLabelAlignment.Center, true);
